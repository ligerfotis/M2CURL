...
def import_parameters(env_name, algo_name):
    ...
    if "ppo" in algo_name:
        if "mvitac" in algo_name:
            #     aug_dict = {
            #         "visual": augmentations,
            #         "tactile": augmentations_tactile,
            #     }
            return rl_params_mvitacrl_ppo, mvitac_rl_ppo_params, augmentations
        else:
        ...
        if "mvitac" in algo_name:
            ...
            #         "tactile": augmentations_tactile,
            #     }
            return rl_params_mvitacrl_sac, mvitac_rl_sac_params, augmentations
        else:
